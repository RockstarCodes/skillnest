...
CREATE TABLE IF NOT EXISTS subjects (
  ...
  KEY idx_subjects_published (is_published)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sections (
  ...
  updated_at DATETIME NOT NULL,
  PRIMARY KEY (id),
  KEY idx_sections_subject_order (subject_id, order_index),
...
CREATE TABLE IF NOT EXISTS videos (
  ...
  updated_at DATETIME NOT NULL,
  PRIMARY KEY (id),
  KEY idx_videos_section_order (section_id, order_index),
...
CREATE TABLE IF NOT EXISTS video_progress (
  ...
  KEY idx_video_progress_user_completed (user_id, is_completed),
